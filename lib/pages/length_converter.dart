...
class _LengthConverterPageState extends State<LengthConverterPage> {
                  ...
                  ElevatedButton(
                    onPressed: () {
                      if (inputController.text.isEmpty ||
                          ...
                          selectedUnit2 == null) {
                        _showErrorDialog(
                            'Please enter length and select units.');
                      } else {
                        inputLength = inputController.text;
                        try {
                          convertFunctions functions = convertFunctions();
                          setState(() {
                            result = functions.unitConvertor(
                                "length",
                                double.parse(inputLength!),
                                selectedUnit1!,
                                selectedUnit2!);
                          });
                        } catch (e) {
  ...
  // static const Map<String, Map<String, double>> lengthconverter = {
  ...
  // void convertLength(double input) {
  //   input = input * lengthconverter[selectedUnit1]![selectedUnit2]!;
  //   setState(() {

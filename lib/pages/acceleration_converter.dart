...
class AccelerationConverterPage extends StatefulWidget {
  @override
  _AccelerationConverterPageState createState() =>
      _AccelerationConverterPageState();
}

class _AccelerationConverterPageState extends State<AccelerationConverterPage> {
              ...
              children: [
                Container(
                  ...
                  child: DropdownButton<String>(
                    ...
                    items: <String>['m/s²', 'km/s²', 'cm/s²', 'mm/s²']
                ...
                ElevatedButton(
                  onPressed: () {
                    if (inputController.text.isEmpty ||
                        ...
                        selectedUnit2 == null) {
                      _showErrorDialog(
                          'Please enter acceleration and select units.');
                    } else {
                      inputAcc = inputController.text;
                      try {
                        convertFunctions functions = convertFunctions();
                        setState(() {
                          result = functions.unitConvertor(
                              "acc",
                              double.parse(inputAcc!),
                              selectedUnit1!,
                              selectedUnit2!);
                        });
                      } catch (e) {
